...
export const Chart = () => {
  ...
  //   const canvas = select('body').select('#root').select('#wrapper')
  //     .append('svg')
  ...
  //   const linearYScale = scaleLinear()
  ...
  //   const xAxis = axisBottom(linearXScale)
  //   const yAxis = axisRight(linearYScale)
